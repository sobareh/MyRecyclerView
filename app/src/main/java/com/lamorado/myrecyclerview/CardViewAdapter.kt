...
import com.lamorado.myrecyclerview.Hero as Hero1

class CardViewAdapter(private val listHeroes: ArrayList<Hero1>) : RecyclerView.Adapter<CardViewAdapter.CardViewHolder>() {
